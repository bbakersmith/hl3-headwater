...
static int8_t CLOCK_EXT_MODE_SYNC = 0;
static int8_t CLOCK_EXT_MODE_TAP = 1;
static int8_t CLOCK_EXT_MODE_EXT = 2;
static int8_t CLOCK_EXT_MODE_CV = 3;
...
static uint16_t BPM_MIN = 10;
static uint16_t BPM_MAX = 3000;
...
static int8_t CLOCK_STATE_DEFAULT_EXT_MODE = 0;
